...
type AuditClassSpec struct {
	...
	// +optional
	RequestSelectors []RequestSelector `json:"requestSelectors,omitempty" protobuf:"bytes,1,rep,opt,name=requestSelectors"`
	// +optional
	ResourceSelectors []ResourceSelector `json:"resourceSelectors,omitempty" protobuf:"bytes,1,rep,opt,name=resourceSelectors"`
	// +optional
	ClusterResourceSelectors []ClusterResourceSelector `json:"clustResourceSelectors,omitempty" protobuf:"bytes,1,rep,opt,name=clusterResourceSelectors"`
	// +optional
...
type RequestSelector struct {
	...
	// +optional
	Users []string `json:"users,omitempty" protobuf:"bytes,1,rep,opt,name=users"`

	// `userGroups` in this selector. A user is considered matching
	// if it is a member of any of the `userGroups`.
	// An empty list implies every user group.
	// +optional
	UserGroups []string `json:"userGroups,omitempty" protobuf:"bytes,2,rep,opt,name=userGroups"`

	// `verbs` included in this selector.
	// An empty list implies every verb.
	// +optional
	Verbs []string `json:"verbs,omitempty" protobuf:"bytes,3,rep,opt,name=verbs"`
}
type ResourceSelector struct {
	...
	// +optional
	Namespaces []string `json:"namespaces,omitempty" protobuf:"bytes,1,rep,opt,name=namespaces"`

	// `resources` in this selector. An empty list implies all kinds in all API groups.
	// +optional
	Resources []GroupResources `json:"resources,omitempty" protobuf:"bytes,2,rep,opt,name=resources"`
}
...
type ClusterResourceSelector struct {
	...
	// `resources` in this selector. An empty list implies all kinds in all API groups.
	// +optional
	Resources []GroupResources `json:"resources,omitempty" protobuf:"bytes,1,rep,opt,name=resources"`
}
...
type NonResourceSelector struct {
	...
	// +optional
	NonResourceURLs []string `json:"nonResourceURLs,omitempty" protobuf:"bytes,1,rep,opt,name=nonResourceURLs"`
}
...
type GroupResources struct {
	...
	// +optional
	Resources []string `json:"resources,omitempty" protobuf:"bytes,2,rep,opt,name=resources"`

	// `objectNames` is a list of resource instance names in this group.
	// Using this field requires resources to be specified.
	// An empty list implies that every instance of the resource is matched.
	// +optional
	ObjectNames []string `json:"objectNames,omitempty" protobuf:"bytes,3,rep,opt,name=objectNames"`
}