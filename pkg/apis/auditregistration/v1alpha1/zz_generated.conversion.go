...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.NonResourceSelector)(nil), (*auditregistration.NonResourceSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NonResourceSelector_To_auditregistration_NonResourceSelector(a.(*v1alpha1.NonResourceSelector), b.(*auditregistration.NonResourceSelector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*auditregistration.NonResourceSelector)(nil), (*v1alpha1.NonResourceSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_auditregistration_NonResourceSelector_To_v1alpha1_NonResourceSelector(a.(*auditregistration.NonResourceSelector), b.(*v1alpha1.NonResourceSelector), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.ResourceSelector)(nil), (*auditregistration.ResourceSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ResourceSelector_To_auditregistration_ResourceSelector(a.(*v1alpha1.ResourceSelector), b.(*auditregistration.ResourceSelector), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.SubjectSelector)(nil), (*auditregistration.SubjectSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SubjectSelector_To_auditregistration_SubjectSelector(a.(*v1alpha1.SubjectSelector), b.(*auditregistration.SubjectSelector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*auditregistration.SubjectSelector)(nil), (*v1alpha1.SubjectSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_auditregistration_SubjectSelector_To_v1alpha1_SubjectSelector(a.(*auditregistration.SubjectSelector), b.(*v1alpha1.SubjectSelector), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BaseSelector_To_auditregistration_BaseSelector(in *v1alpha1.BaseSelector, out *auditregistration.BaseSelector, s conversion.Scope) error {
	out.Subjects = *(*[]auditregistration.SubjectSelector)(unsafe.Pointer(&in.Subjects))
...
func autoConvert_auditregistration_BaseSelector_To_v1alpha1_BaseSelector(in *auditregistration.BaseSelector, out *v1alpha1.BaseSelector, s conversion.Scope) error {
	out.Subjects = *(*[]v1alpha1.SubjectSelector)(unsafe.Pointer(&in.Subjects))
	out.Verbs = *(*[]string)(unsafe.Pointer(&in.Verbs))
	return nil
}
...
func autoConvert_v1alpha1_GroupResourceSelector_To_auditregistration_GroupResourceSelector(in *v1alpha1.GroupResourceSelector, out *auditregistration.GroupResourceSelector, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ScopeSelector_To_auditregistration_ScopeSelector(&in.ScopeSelector, &out.ScopeSelector, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_auditregistration_GroupResourceSelector_To_v1alpha1_GroupResourceSelector(in *auditregistration.GroupResourceSelector, out *v1alpha1.GroupResourceSelector, s conversion.Scope) error {
	...
	if err := Convert_auditregistration_ScopeSelector_To_v1alpha1_ScopeSelector(&in.ScopeSelector, &out.ScopeSelector, s); err != nil {
		return err
	}
	return nil
}
...
// Convert_v1alpha1_NonResourceSelector_To_auditregistration_NonResourceSelector is an autogenerated conversion function.
func Convert_v1alpha1_NonResourceSelector_To_auditregistration_NonResourceSelector(in *v1alpha1.NonResourceSelector, out *auditregistration.NonResourceSelector, s conversion.Scope) error {
	return autoConvert_v1alpha1_NonResourceSelector_To_auditregistration_NonResourceSelector(in, out, s)
}
...
// Convert_auditregistration_NonResourceSelector_To_v1alpha1_NonResourceSelector is an autogenerated conversion function.
func Convert_auditregistration_NonResourceSelector_To_v1alpha1_NonResourceSelector(in *auditregistration.NonResourceSelector, out *v1alpha1.NonResourceSelector, s conversion.Scope) error {
	return autoConvert_auditregistration_NonResourceSelector_To_v1alpha1_NonResourceSelector(in, out, s)
}
...
// Convert_v1alpha1_ResourceSelector_To_auditregistration_ResourceSelector is an autogenerated conversion function.
func Convert_v1alpha1_ResourceSelector_To_auditregistration_ResourceSelector(in *v1alpha1.ResourceSelector, out *auditregistration.ResourceSelector, s conversion.Scope) error {
	return autoConvert_v1alpha1_ResourceSelector_To_auditregistration_ResourceSelector(in, out, s)
}
...
func autoConvert_v1alpha1_SubjectSelector_To_auditregistration_SubjectSelector(in *v1alpha1.SubjectSelector, out *auditregistration.SubjectSelector, s conversion.Scope) error {
	out.Type = auditregistration.SubjectType(in.Type)
	out.Names = *(*[]string)(unsafe.Pointer(&in.Names))
	return nil
}

// Convert_v1alpha1_SubjectSelector_To_auditregistration_SubjectSelector is an autogenerated conversion function.
func Convert_v1alpha1_SubjectSelector_To_auditregistration_SubjectSelector(in *v1alpha1.SubjectSelector, out *auditregistration.SubjectSelector, s conversion.Scope) error {
	return autoConvert_v1alpha1_SubjectSelector_To_auditregistration_SubjectSelector(in, out, s)
}

func autoConvert_auditregistration_SubjectSelector_To_v1alpha1_SubjectSelector(in *auditregistration.SubjectSelector, out *v1alpha1.SubjectSelector, s conversion.Scope) error {
	out.Type = v1alpha1.SubjectType(in.Type)
	out.Names = *(*[]string)(unsafe.Pointer(&in.Names))
	return nil
}

// Convert_auditregistration_SubjectSelector_To_v1alpha1_SubjectSelector is an autogenerated conversion function.
func Convert_auditregistration_SubjectSelector_To_v1alpha1_SubjectSelector(in *auditregistration.SubjectSelector, out *v1alpha1.SubjectSelector, s conversion.Scope) error {
	return autoConvert_auditregistration_SubjectSelector_To_v1alpha1_SubjectSelector(in, out, s)
}
